...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.example.citygame/databases/";
  ...
  /**
    ...
    public Cursor openCursor(String sqlStatement, String[] selectionArgs){
    	Cursor cursor = database.rawQuery(sqlStatement, selectionArgs);
    	return cursor;
    }
    ...
    public void getCursorData(String sqlStatement) {
